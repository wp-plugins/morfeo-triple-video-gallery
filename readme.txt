...
Contributors: wpvideoplugins.com
Donate link: http://www.wpvideoplugins.com/morfeo-video-gallery/
Tags: youtube, play, video, admin, posts, Post, media, buddypress, flash, flv, AJAX, android, apple, blackberry, bravenewcode, iphone, ipod, mac, mobile, smartphone, theme, wptouch
...
1. Upload `morfeo-triple` folder to the `/wp-content/plugins/` directory.
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Configure and create new video gallery in your Wordpress Admin: Morfeo triple
4. Place [`morfeo_triple` ID /] in your Posts, where ID is the gallery ID.
...
= What parameters should I set up to look good to me the morfeo? =
...
* **Pause button:** Pause button disappears, error fixed.

= 1.2 =

* **Youtube:** Optimization of the quality of the videos from youtube.
* **Search engines:** Code optimization for search engines.
